...
interface BorderTokensDisplayProps {
...
function BorderCard({ name, value, isDarkMode }: BorderCardProps) {
...
export function BorderTokensDisplay({ borderWidth, isDarkMode = false }: BorderTokensDisplayProps) {
  ...
  return (
    <div style={sectionStyle}>
      <h2 style={sectionTitleStyle}>Border Width</h2>
      <p style={descriptionStyle}>
        Border width tokens for stroke widths. Click to copy values.
      </p>

      <div style={gridStyle}>
        {borderWidth.tokens.map((token, index) => {
